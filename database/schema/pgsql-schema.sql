...
--
-- Name: action_measure; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: action_user; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.action_user (
    action_id integer NOT NULL,
...
--
-- Name: control_user_group; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: user_user_group; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_user_group (
    user_id bigint NOT NULL,
    user_group_id integer NOT NULL
);
...
--
-- Name: action_measure action_measure_action_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.action_measure
    ADD CONSTRAINT action_measure_action_id_foreign FOREIGN KEY (action_id) REFERENCES public.actions(id);


--
-- Name: action_measure action_measure_measure_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: action_user action_user_action_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.action_user
    ADD CONSTRAINT action_user_action_id_foreign FOREIGN KEY (action_id) REFERENCES public.actions(id);


--
-- Name: action_user action_user_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.action_user
    ADD CONSTRAINT action_user_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id);


--
-- Name: actions actions_control_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: control_user_group control_user_group_control_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: control_user_group control_user_group_user_group_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.control_user_group
    ADD CONSTRAINT control_user_group_user_group_id_foreign FOREIGN KEY (user_group_id) REFERENCES public.user_groups(id);
...
--
-- Name: user_user_group user_user_group_user_group_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_user_group
    ADD CONSTRAINT user_user_group_user_group_id_foreign FOREIGN KEY (user_group_id) REFERENCES public.user_groups(id);


--
-- Name: user_user_group user_user_group_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_user_group
    ADD CONSTRAINT user_user_group_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id);
...
29	2024_11_06_123808_add_actions	2
